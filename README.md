...
|------|----------|------------|----------|----------|
| 创建型 | **单例 (Singleton)** | 保证一个类只有一个实例 | [查看笔记](./creational-patterns/singleton.md) | ⏳ |
| 创建型 | **工厂方法 (Factory Method)** | 将对象创建延迟到子类 | [查看笔记](./creational-patterns/factory-method.md) | ⏳ |
...
| 结构型 | **代理 (Proxy)** | 控制对象访问 | [查看笔记](./structural-patterns/proxy.md) | ⏳ |
